<template>
  <q-card class="my-pivottable">
    <q-card-section>
      <div class="table-header text-h6">Biome Footprint</div>
...
<script>
import img_derpshirevalley from 'src/assets/derpshire_valley.png';
import img_chillarcticadrifts from 'src/assets/chillarctica_drifts.png';
import img_sandcryptbandlands from 'src/assets/sandcrypt_bandlands.png';
import img_chillvinejungle from 'src/assets/chillvine_jungle.png';
import img_pinnacleperch from 'src/assets/pinnacle_perch.png';
import img_baldosbog from 'src/assets/baldos_bog.png';
import img_lavalodepeaks from 'src/assets/lavalode_peaks.png';
...
export default {
  ...
  props: {
    Pivottable_Data: {
      ...
      validator(value) {
        return value && Array.isArray(value.columns) && Array.isArray(value.data);
      },
    },
  },
  computed: {
    hasValidData() {
      return this.Pivottable_Data && this.Pivottable_Data.columns && this.Pivottable_Data.data;
    },
    mainHeaders() {
      return this.hasValidData ? this.Pivottable_Data.columns[0] : [];
    },
    subHeaders() {
      return this.hasValidData ? this.Pivottable_Data.columns[1] : [];
    },
    bodyRows() {
    ...
    lastRow() {
      return this.hasValidData ? this.Pivottable_Data.data[this.Pivottable_Data.data.length - 1] : [];
    },
    mergedMainHeaders() {
      const headers = [];
